...
RadialStencil::RadialStencil()
{
	...
	//Second Ring
	stencil.push_back(std::pair<CubeCoords, int>(CubeCoords(2, 0, -2), 2));
	stencil.push_back(std::pair<CubeCoords, int>(CubeCoords(2, -1, -1), 2));
	stencil.push_back(std::pair<CubeCoords, int>(CubeCoords(2, -2, 0), 2));
	stencil.push_back(std::pair<CubeCoords, int>(CubeCoords(1, -2, 1), 2));
	stencil.push_back(std::pair<CubeCoords, int>(CubeCoords(0, -2, 2), 2));
	stencil.push_back(std::pair<CubeCoords, int>(CubeCoords(-1, -1, 2), 2));
	stencil.push_back(std::pair<CubeCoords, int>(CubeCoords(-2, 0, 2), 2));
	stencil.push_back(std::pair<CubeCoords, int>(CubeCoords(-2, 1, 1), 2));
	stencil.push_back(std::pair<CubeCoords, int>(CubeCoords(-2, 2, 0), 2));
	stencil.push_back(std::pair<CubeCoords, int>(CubeCoords(-1, 2, -1), 2));
